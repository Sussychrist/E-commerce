    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if(isset($_GET['id']))
            {
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name" value="<?= $data['name'] ?>" placeholder="Enter Catetogory name" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <img src="../uploads/<?= $data['image'] ?>" height="50px" width="50" alt="" /> 
                                    </div>
                                    <div class="col-md-12">
                ...
                {
                    echo "Something is wrong I can feel it (Category not found)";
                }    
            }
            else
            {
